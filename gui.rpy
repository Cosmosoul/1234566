...
define gui.accent_color = '#c5a319'

## 当文本按钮既未被选中也未被悬停时使用的颜色。
define gui.idle_color = '#a53939'

## 小的颜色用于小的文本，需要更亮/更暗才能达到同样的效果。
define gui.idle_small_color = '#b5acac'

## 当按钮和滑条被悬停时使用的颜色。
define gui.hover_color = '#e9a24b'

## 当文本按钮被选中但非焦点时使用的颜色。当一个按钮为当前屏幕或设置选项值时，会
## 处于选中状态。
define gui.selected_color = '#7c5b0d'
...
## 游戏内文本使用的字体。
define gui.text_font = "HGKT2_CNKI.TTF"

## 角色名称使用的字体。
define gui.name_text_font = "HGDGY_CNKI.TTF"

## 游戏外文本使用的字体。
define gui.interface_text_font = "HGDGY_CNKI.TTF"
...
define gui.game_menu_text_color = '#b70bac'
...
define gui.quick_button_borders = Borders(40, 6, 15, 0)
define gui.quick_button_text_font = "HGDGY_CNKI.TTF"
define gui.quick_button_text_size = 26
define gui.quick_button_text_idle_color = '#aaf8af'
define gui.quick_button_text_hover_color = '#f8aaf3'
...
## 标题菜单和游戏菜单的导航部分中的按钮。
define gui.navigation_spacing = 55
...
define gui.history_name_text_font = "HGDGY_CNKI.TTF"
...
define gui.history_text_font = "SourceHanSansLite.ttf"
